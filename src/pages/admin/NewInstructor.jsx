...
function NewInstructor() {
  ...
  const [emailErr, setEmailErr] = useState(
    "Enter a valid email that includes (@instructor.tuwaiq.sa)"
  );
  ...
  const createInstructor = async () => {
    ...
    } else if (!email.includes("instructor.tuwaiq.sa")) {
      isValid = false;
      setEmailErr("Email must include @instructor.tuwaiq.sa");
    }
    ...
    if (isValid) {
      try {
        ...
        nav("/admin/adminHome");
        // Success toast
        toast.success("Create new instructor successfully!");
      } catch (error) {
        console.error("Error during create new instructor:", error);
        toast.error("An error occurred while registering. Please try again.");
      }
    } else {
      toast.error(
        "Error during create new instructor, Please fix the errors in the form before submitting."
      );
    }
  };
