...
const InstructorDetails = () => {
  ...
  const deleteInstructor = async () => {
    try {
      ...
      navigate("/admin/adminHome/instructorList");
    } catch (error) {
  ...
  const update = async () => {
    try {
      await axios.put(`${api}/user/${id}`, instructor);
      ...
      <div className="min-h-screen flex justify-center items-center bg-gray-50">
        <div className="flex flex-col items-start gap-8 shadow-lg rounded-lg bg-white p-6">
          <div className="flex flex-col items-center justify-center w-full">
            <p className="text-lg font-semibold text-black text-center w-full">
              instructor Details
            </p>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4 mt-4">
              ...
              <button
                onClick={() => navigate("/admin/adminHome/instructorList")}
